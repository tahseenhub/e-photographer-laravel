...
<body>
    ...
    <div class="center-div">
        ...
        <div class="row">
            <div class="col-md-6">
                <a href="{{route('signup.photographer')}}"><button class="work-button_client"><strong>Photographer</strong></button></a>
                <hr class="hr-20px">            

            </div>
            <div class="col-md-6">
                <a href="{{route('signup.client')}}"><button class="hire-button_client active"><strong>Hire Photographer</strong></button></a>
                <hr class="hr-20px">            
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="{{route('google_signup','client')}}" method="get" enctype="multipart/form-data">
                    <input type="hidden" name="user_type" value="client">
                    <button class="gmail-button fa fa-google">&nbsp;&nbsp;&nbsp;&nbsp;Sign UP</strong></button>
                </form>
            </div>
            <div class="col-md-6">
                <button class="fb-button fa fa-facebook">&nbsp;&nbsp;&nbsp;&nbsp;Log In With Facebook</strong></button>
            </div>
        </div>
    </div>
